    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // convert waypoints to host coordinates
          ...
          */
          Eigen::VectorXd x0(6);
          x0 << px_t1, py_t1, psi_t1, v_t1, cte_t1, epsi_t1; // As in the solution of the quiz
          ...
          msgJson["steering_angle"] = - solution[0] / deg2rad(25); // values are flipped in the simulator
          ...
          for (int i = 0; i<ptsx.size();i++) { 
            next_x_vals.push_back(ptsx[i]); // transformed in the vehicle coordinate system
